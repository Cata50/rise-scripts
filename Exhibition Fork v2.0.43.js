/*
 ...
 [+] Modules
  ...
  - Added QOL (contains qol modules, block esp fork from @limhax)
...
// MODULE
var module = rise.registerModule("Exhibition", "By Cata50 - v2.0.43");
...
module.registerSetting("boolean", "Auto Y Port", false);
...
module.setSettingVisibility("Auto Y Port", false);
...
module.handle("onTick", function (tick) {
    ...
    var yPort = module.getSetting("Auto Y Port");
    ...
    module.setSettingVisibility("Auto Y Port", qol);
...
module.handle("onRender2D", function (render2) {
    ...
    if (blockCounterColor === "colored" && scaffold.isEnabled() && blockCounter && ((blockCounterMode === "hotbar" && heldItem.getItemId() !== 0) || blockCounterMode === "inv")) {
        ...
        if (customFont) {
            if (totalBlocks <= 1000 && totalBlocks >= 100) {
                badcache18.drawWithShadow(totalBlocks, blockCounterX - 0.5, blockCounterY, scaffoldColor());
            } else if (totalBlocks <= 100 && totalBlocks >= 10) {
                badcache18.drawWithShadow(totalBlocks, blockCounterX + 1.25, blockCounterY, scaffoldColor());
            } else if (totalBlocks <= 10) {
                badcache18.drawWithShadow(totalBlocks, blockCounterX + 4.25, blockCounterY, scaffoldColor());
            }
        } else {
            if (totalBlocks <= 1000 && totalBlocks >= 100) {
                mcFont.drawWithShadow(totalBlocks, blockCounterX - 2, blockCounterY, scaffoldColor());
            } else if (totalBlocks <= 100 && totalBlocks >= 10) {
                mcFont.drawWithShadow(totalBlocks, blockCounterX + 1.5, blockCounterY, scaffoldColor());
            } else if (totalBlocks <= 10) {
                mcFont.drawWithShadow(totalBlocks, blockCounterX + 4, blockCounterY, scaffoldColor());
            }
        }
    } else if (blockCounterColor === "colored" && scaffold.isEnabled() && blockCounter && ((blockCounterMode === "hotbar" && heldItem.getItemId() !== 0) || blockCounterMode === "inv")) {

        scaffold.setSetting("Render", false);
        if (customFont) {
            if (totalBlocks <= 1000 && totalBlocks >= 100) {
                badcache18.drawWithShadow(totalBlocks, blockCounterX - 0.5, blockCounterY, [255, 255, 255]);
            } else if (totalBlocks <= 100 && totalBlocks >= 10) {
                badcache18.drawWithShadow(totalBlocks, blockCounterX + 1.25, blockCounterY, [255, 255, 255]);
            } else if (totalBlocks <= 10) {
                badcache18.drawWithShadow(totalBlocks, blockCounterX + 4.25, blockCounterY, [255, 255, 255]);
            }
        } else {
            if (totalBlocks <= 1000 && totalBlocks >= 100) {
                mcFont.drawWithShadow(totalBlocks, blockCounterX - 2, blockCounterY, [255, 255, 255]);
            } else if (totalBlocks <= 100 && totalBlocks >= 10) {
                mcFont.drawWithShadow(totalBlocks, blockCounterX + 1.5, blockCounterY, [255, 255, 255]);
            } else if (totalBlocks <= 10) {
                mcFont.drawWithShadow(totalBlocks, blockCounterX + 4, blockCounterY, [255, 255, 255]);
            }
        }
    } else if (blockCounterColor === "colored" && scaffold.isEnabled() && blockCounter && ((blockCounterMode === "hotbar" && heldItem.getItemId() !== 0) || blockCounterMode === "inv")) {
        ...
        if (customFont) {
            if (totalBlocks <= 1000 && totalBlocks >= 100) {
                badcache18.drawWithShadow(totalBlocks, blockCounterX - 0.5, blockCounterY, render.getThemeColor());
            } else if (totalBlocks <= 100 && totalBlocks >= 10) {
                badcache18.drawWithShadow(totalBlocks, blockCounterX + 1.25, blockCounterY, render.getThemeColor());
            } else if (totalBlocks <= 10) {
                badcache18.drawWithShadow(totalBlocks, blockCounterX + 4.25, blockCounterY, render.getThemeColor());
            }
        } else {
            if (totalBlocks <= 1000 && totalBlocks >= 100) {
                mcFont.drawWithShadow(totalBlocks, blockCounterX - 2, blockCounterY, render.getThemeColor());
            } else if (totalBlocks <= 100 && totalBlocks >= 10) {
                mcFont.drawWithShadow(totalBlocks, blockCounterX + 1.5, blockCounterY, render.getThemeColor());
            } else if (totalBlocks <= 10) {
                mcFont.drawWithShadow(totalBlocks, blockCounterX + 4, blockCounterY, render.getThemeColor());
            }
        }
    }
    ...
    if (playtime) {
        ...
        if (qol) {
            if (player.isPotionActive(8)) {
                speed.setSetting("Y Port", false);
            } else if (yPort) {
                speed.setSetting("Y Port", player.isPotionActive(1));
            }
        }
    }
});;
